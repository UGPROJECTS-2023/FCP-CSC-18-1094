               ...
               <div class="span12">
                        <div class="hero-unit-3">
                            ...
                            <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example">
                                <div class="alert alert-info">
                                    ...
                                    <strong><i class="icon-user icon-large"></i>&nbsp;Non Admitted Students' List (POST-UTME)</strong>
                                </div>
                                <thead>
                                    <tr>
						...
						<th>ACTION</th>
                                ...
                                <tbody>
                                    ...
                                    $query = mysqli_query($con, "select * from result_sheet WHERE department = '$eo_department' AND status = '0' AND adm_type = 'pe'") or die(mysql_error());
